            ...
            <form action="#" method="POST" enctype="multipart/form-data">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="precio" name="precio" class="form-control" placeholder="Ej: 2500000"
                            required>
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="anio">Año de Fabricación *</label>
                        <input type="number" id="anio" name="anio" class="form-control" placeholder="Ej: 1944"
                            min="1914" max="2026" required>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="descripcion" name="descripcion" class="form-control"
                        placeholder="Describe el historial del avión, restauraciones, horas de vuelo, documentación, etc..." required></textarea>
                </div>
                ...
                <div style="background: var(--white); padding: 1.5rem; border-radius: 5px; margin-bottom: 1.5rem;">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" id="vendedor_email" name="vendedor_email" class="form-control"
                                required>
                        </div>
